...
export default function Saction2(){
    ...
    return (
        ...
        {/* saction 5 */}
        <div className="flex flex-col justify-between py-20 items-center gap-20 bg-[#F2FD01] relative ">
        <div className="rounded-full-css bg-black w-full rotate-180 h-10 bottom-0 absolute z-10 "></div>
        <div className="  rounded-full-css  bg-black w-full h-10 top-0 absolute z-10 "></div>
