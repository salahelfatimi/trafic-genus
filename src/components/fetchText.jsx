  ...
  return (
    <>
      {images.map((ele, index) => (
        <div className=" relative duration-700 bg-black hover:bg-gradient-to-b from-[#F2FD01] group   via-[#6a6e24] to-[#000] space-x-6  p-10 flex flex-col items-center justify-start gap-20  border-2   border-[#fff]  min-w-96  " key={index}>
