    ...
    return (
        ...
        <div className="flex flex-col justify-between py-20 items-center gap-32 bg-gradient-to-b from-[#F2FD01]  via-[#F2FD01] to-[#fff]">
          <div className="flex-col flex items-center">
            ...
            <h2 className="lg:text-5xl text-lg font-black text-center">
              Voici un aperçu de ce que nous sommes prêts à vous offrir !
            </h2>
          </div>
            <div className=" container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10  items-start justify-center">
                ...
                <div className=" flex flex-col items-center gap-10 justify-center">
                    ...
                    <div className=" gap-4   flex flex-col justify-center items-center">
                        <h3 className=" 2xl:text-3xl  text-center uppercase">Sites internet</h3>
                        <p className=" text-center font-serif text-xs 2xl:text-base font-normal">Chez trafic genius trafic genius, nous sommes spécialisés dans la conception et le développement de sites web personnalisés pour répondre aux besoins uniques de nos clients. Que vous souhaitiez créer un site vitrine pour présenter votre entreprise, un site e-commerce pour vendre vos produits en ligne, ou tout autre type de site web, nous sommes là pour vous aider.</p>
                    </div>
                </div>
                <div className=" flex flex-col items-center gap-10 justify-center">
                    <div className=" bg-[#F2FD01] p-2 rounded-2xl border-8 border-black  shadow-2xl">
                    ...
                    <div className="  gap-4  flex flex-col justify-center items-center">
                        <h3 className="2xl:text-3xl  text-center uppercase">Applications Web et Mobile</h3>
                        <p className=" text-center font-serif text-xs 2xl:text-base font-normal">Nous comprenons l&apos;importance des applications web et mobiles dans le monde numérique d&apos;aujourd&apos;hui. Chez trafic genius trafic genius, nous nous spécialisons dans la création d&apos;applications sur mesure qui répondent aux besoins uniques de nos clients. Que vous souhaitiez développer une application pour votre entreprise, une plateforme de commerce électronique, une application de service à la clientèle ou toute autre idée innovante, nous sommes là pour vous aider à concrétiser votre vision.</p>
                    </div>
                </div>
                <div className=" flex flex-col items-center gap-10 justify-center">
                    <div className=" bg-[#F2FD01] p-2 rounded-2xl border-8 border-black  shadow-2xl">
                    ...
                    <div className=" gap-4   flex flex-col justify-center items-center">
                        <h3 className=" 2xl:text-3xl  text-center uppercase">Automatisation</h3>
                        <p className=" text-center font-serif text-xs 2xl:text-base font-normal">Nous comprenons l&apos;importance d&apos;optimiser votre processus de marketing automatisé. C&apos;est pourquoi nous offrons des fonctionnalités avancées d&apos;automatisation pour maximiser l&apos;efficacité et les résultats de votre tunnel. Grâce à nos automatisations bien pensées, vous pouvez simplifier vos tâches, économiser du temps et offrir une expérience personnalisée à chaque étape du parcours de votre audience.</p>
                    </div>
                </div>
                <div className=" flex flex-col items-center gap-10 justify-center">
                    <div className=" bg-[#F2FD01] p-2 rounded-2xl border-8 border-black  shadow-2xl">
                    ...
                    <div className=" gap-4   flex flex-col justify-center items-center">
                        <h3 className=" 2xl:text-3xl text-center uppercase">Facebook et Instagram Ads</h3>
                ...
                <div className=" flex flex-col items-center gap-10 justify-center">
                    ...
                    <div className=" gap-4  flex flex-col justify-center items-center">
                        <h3 className=" 2xl:text-3xl  text-center uppercase">Accompagnement</h3>
                        <p className=" text-center font-serif text-xs 2xl:text-base font-normal">Notre  approche de l&apos;accompagnement se caractérise par une approche complète et personnalisée qui vise à vous soutenir à chaque étape de votre projet. Nous croyons en l&apos;importance de comprendre vos besoins spécifiques, de vous fournir des conseils d&apos;experts et de travailler en étroite collaboration avec vous pour atteindre vos objectifs.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div>
                <div className=" container grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className=" flex flex-col justify-center gap-20">
                        <p className=" font-serif text-xs lg:text-base font-semibold flex  gap-4 "><CirclePlus  size={50} />Spécialisés en funnel building depuis plusieurs années, nous nous engageons à vous délivrer ce qu&apos;il y a de meilleur, au plus proche de la perfection.</p>
                        <p className="  font-serif text-xs lg:text-base font-semibold flex  gap-4"><CirclePlus size={50} />Attirez l&apos;attention de vos visiteurs, transformez-les en clients et augmentez votre chiffre d&apos;affaires grâce à un tunnel de vente professionnel à haute rentabilité.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className=" flex gap-28 flex-col justify-center items-center bg-gradient-to-b from-black  via-black to-[#F2FD01] py-20">
                <div className="flex-col flex items-center">
                    <div className="w-screen overflow-hidden">
                        ...
                        <h2 className="lg:text-5xl text-lg font-black text-center text-white">Imaginez votre projet sous son meilleur <span className=" bg-[#F2FD01] p-[0.10rem]  "><span className="relative text-black"> JOUR </span></span></h2>
                </div>
        ...
        <div className="bg-gradient-to-b from-[#F2FD01]  via-[#F2FD01] to-[#ccd42a]">
            <div className="flex container flex-col gap-20 py-20  ">
                <div className=" ">
                    <h2 className="lg:text-4xl text-lg font-black text-center text-black">JETEZ UN COUP D&apos;ŒIL SUR UN DE NOS “REDESIGN“ EXPÉRIENCES, POUR VOIR CE QUE NOUS POUVONS FAIRE                </h2>
                </div>
            ...
            <div className="flex flex-col gap-20 py-20 container  ">
                ...
                <div className=" container flex flex-col lg:flex-row items-center justify-around gap-8">
                    ...
                    <div className=" flex flex-col justify-center items-center gap-20">
                        <p className=" font-serif font-semibold flex text-xs lg:text-base   gap-2 "><CirclePlus   className=" w-6 min-w-6 h-6"/>Faites de vos rêves une réalité avec un site web interactif au design créatif !</p>
                        <p className=" lg:pl-20  font-serif font-semibold  text-xs lg:text-base flex  gap-2"><CirclePlus  className=" w-6 min-w-6 h-6"/>Un site internet unique, personnalisé et avant-gardiste pour vous démarquer pour maximiser votre rentabilité.</p>
                        <p className="  font-serif font-semibold flex text-xs lg:text-base  gap-2"><CirclePlus className=" w-6 min-w-6 h-6" />Nous nous engageons à ce que chacune des pages que nous créons soit parfaitement optimisée pour une expérience utilisateur optimale sur ordinateur et mobile.</p>
            ...
            <div className=" flex flex-col gap-8 ">
                ...
                <div className=" container flex flex-col gap-10 items-center justify-center ">
                    <div className=" text-center text-black">
                        <h2 className="lg:text-4xl text-lg font-black text-center text-black">
            ...
            <div className=" container  flex gap-28 flex-col justify-center items-center  py-20">
                <div className="flex-col flex items-center gap-2 justify-center">
                    <div className="w-screen overflow-hidden">
                        ...
                        <h2 className="lg:text-4xl text-lg font-black text-center text-white capitalize ">trafic genius, UNE ÉQUIPE DE PROFESSIONNELLES À  <span className=" bg-[#F2FD01] p-[0.10rem]  "><span className="relative text-black"> VOS CÔTÉS </span></span></h2>
                </div>
                
                <div className="  lg:w-[70%] font-serif font-medium text-white text-center lg:text-2xl border-[#F2FD01] border-4 p-4 rounded-3xl">
                    <p>
            ...
            <div className="  py-20 relative z-20   flex flex-col gap-20">
                ...
                <div className="   ">
                    ...
                    <div className="container  relative">
                        <h2 className="relative container lg:text-4xl text-lg text-center font-black  text-white">Ce qui nous rend unique  aux yeux de nos clients</h2>
