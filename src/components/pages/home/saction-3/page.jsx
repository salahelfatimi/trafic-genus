        ...
        <div className=" py-20 flex flex-col ">
            ...
            <div className=" bg-white">
                <div className="  container flex flex-col items-center justify-center gap-20">
                        <div className=" flex flex-col items-center justify-center  ">
                            ...
                            <h2 className=" text-center lg:text-5xl text-lg font-black  text-black">Les 5 étapes pour mener à bien votre PROJET </h2>                     
                        </div>  
                        <div className=" container">
                            <div className=" grid grid-cols-1 md:grid-cols-1 2xl:grid-cols-5 items-center   justify-center text-center gap-8">
                                <div onClick={()=>(setclickNum(0),scrollToSection())} className={` ${clickNum==0?' bg-[#F2FD01] text-black border-black border-4 shadow-2xl':'bg-[#4F4F4F] text-white  '} duration-700 cursor-pointer text-sm 	  hover:bg-[#F2FD01] hover:text-black  rounded-xl p-6`}>
                                    Étape 1 :Audit
                                </div>
                                <div onClick={()=>(setclickNum(1),scrollToSection())} className={` ${clickNum==1?' bg-[#F2FD01] text-black border-black border-4 shadow-2xl':'bg-[#4F4F4F] text-white '} duration-700 cursor-pointer text-sm  	  hover:bg-[#F2FD01] hover:text-black  rounded-xl p-6`}>
                                    Étape 2 : Réalisation
                                </div>
                                <div onClick={()=>(setclickNum(2),scrollToSection())} className={` ${clickNum==2?' bg-[#F2FD01] text-black border-black border-4 shadow-2xl':'bg-[#4F4F4F] text-white '} duration-700 cursor-pointer text-sm  	  hover:bg-[#F2FD01] hover:text-black  rounded-xl p-6`}>
                                Étape 3 : Livraison et ajustements
                                </div>
                                <div onClick={()=>(setclickNum(3),scrollToSection())} className={` ${clickNum==3?' bg-[#F2FD01] text-black border-black border-4 shadow-2xl':'bg-[#4F4F4F] text-white '} duration-700 cursor-pointer text-sm  	  hover:bg-[#F2FD01] hover:text-black  rounded-xl p-6`}>
                                    Étape 4 : Lancement
                                </div>
                                <div onClick={()=>(setclickNum(4),scrollToSection())} className={` ${clickNum==4?' bg-[#F2FD01] text-black border-black border-4 shadow-2xl':'bg-[#4F4F4F] text-white '} duration-700 cursor-pointer text-sm  	  hover:bg-[#F2FD01] hover:text-black  rounded-xl p-6`}>
                        ...
                        <div id="etapes" className=" container flex flex-col lg:flex-row gap-8 items-center justify-center ">
                            ...
                            <div className="bg-[#4F4F4F] flex flex-col justify-center items-center rounded-md shadow-2xl gap-4 p-4 ">
                                <h3 className=" text-[#F2FD01] text-3xl text-center ">{filterText.title}</h3>
                                <p className="  text-center font-serif font-semibold text-white text-sm lg:text-xl">{filterText.description}</p>
                            </div>
            ...
            <div className="  relative  flex flex-col justify-center items-center pt-20">
                ...
                <div   className="z-10 bg-[url('/BACKGROUND.jpg')] bg-cover border-[#F2FD01] border-8 shadow-2xl gap-10 rounded-3xl p-6 lg:p-20 w-fit flex flex-col justify-center items-center">
                    <h4 className="  text-[#fff] text-lg text-center lg:text-4xl">PRÊT POUR DÉCOLLER ENSEMBLE ?</h4>
                ...
                <div className=" container relative flex flex-col gap-24 items-center justify-center py-20 ">
                    <div className=" ">
                        <div className=" flex flex-col ">
                            ...
                            <h2 className=" text-center lg:text-5xl text-lg font-black  text-black">Ensemble on développe de votre entreprise AVEC</h2>                     
                        </div> 
                    ...
                    <div className=" container flex flex-col gap-20  ">
                        <div className=" flex flex-col lg:flex-row  gap-20 justify-between items-start  ">
                            ...
                            <h4 className={` bg-white  text-sm p-6 ${clickShow==1?' rounded-t-3xl':'rounded-3xl'}  flex flex-row justify-between items-center shadow-2xl border-4 border-black`}>Réactivité{clickShow==1?<X onClick={()=>(setclickShow(0))}  className=" cursor-pointer"/>:<ChevronDown onClick={()=>(setclickShow(1))}  className=" cursor-pointer"/>}</h4>
                            ...
                            <div className="  relative flex flex-col  w-full ">
                                <h4 className={` bg-white  text-sm p-6 ${clickShow==2?' rounded-t-3xl':'rounded-3xl'}  flex flex-row justify-between items-center shadow-2xl border-4 border-black`}>Innovation{clickShow==2?<X onClick={()=>(setclickShow(0))}  className=" cursor-pointer"/>:<ChevronDown onClick={()=>(setclickShow(2))}  className=" cursor-pointer"/>}</h4>
                        ...
                        <div className=" flex flex-col lg:flex-row  gap-20 justify-between items-start ">
                            <div className=" relative  flex flex-col w-full ">
                            <h4 className={` bg-white  text-sm p-6 ${clickShow==3?' rounded-t-3xl':'rounded-3xl'}  flex flex-row justify-between items-center shadow-2xl border-4 border-black`}>Confiance{clickShow==3?<X onClick={()=>(setclickShow(0))}  className=" cursor-pointer"/>:<ChevronDown onClick={()=>(setclickShow(3))}  className=" cursor-pointer"/>}</h4>
                            ...
                            <div className=" relative  flex flex-col  w-full ">
                                <h4 className={` bg-white  text-sm p-6 ${clickShow==4?' rounded-t-3xl':'rounded-3xl'}  flex flex-row justify-between items-center shadow-2xl border-4 border-black`}>Satisfaction{clickShow==4?<X onClick={()=>(setclickShow(0))}  className=" cursor-pointer"/>:<ChevronDown onClick={()=>(setclickShow(4))}  className=" cursor-pointer"/>}</h4>
            ...
            <div className="bg-white">
                <div className=" container flex flex-col gap-20  py-20">
                    <div className=" flex flex-col items-center justify-center  ">
                        ...
                        <h2 className=" text-center lg:text-5xl text-lg font-black  text-black">UNIQUEMENT POUR LES ENTREPRENEURS MOTIVÉS </h2>                     
                    </div>  
                    <div className=" container flex flex-col-reverse lg:flex-row-reverse justify-center items-center">
                        <div className=" text-left   lg:w-[70%] font-serif font-medium text-sm  lg:text-2xl border-[#000] border-4 p-6 rounded-3xl  shadow-2xl">
                            <p>
            ...
            <div className=" container relative  flex flex-col justify-center items-center pt-20">
                ...
                <div className="z-10 bg-[url('/BACKGROUND.jpg')] bg-cover border-8 shadow-2xl border-[#F2FD01]  gap-10 rounded-3xl p-6 lg:p-20  flex flex-col justify-center items-center">
                    <h4 className="  text-[#fff] text-lg text-center lg:text-4xl font-sans font-bold">Boostez votre entreprise grâce à notre expertise en scaling</h4>
                    <div className=" border-t-4 border-[#F2FD01] w-full"></div>
                    <p className=" font-serif text-sm  text-white font-medium text-center lg:text-2xl">Prenez contact et échangeons ensemble sur votre projet
                    </p>
                    <Link href={'/appel'} target="_blank" >
                    <button className="cssbuttons-io-button ">
                        RÉSERVEZ VOTRE APPEL
                    ...
                    <div className="  ">
                     <div className=" p-8">
                        <details className="bg-[#F2FD01]   open:ring-[#F2FD01]  border-t-4 border-x-4  border-[#000] shadow-2xl py-10 border-b-4 rounded-t-3xl p-4 " open>
                            <summary className="lg:text-xl text-base font-serif font-bold leading-6 text-[#000] cursor-pointer  select-none">
                            Est-ce que vous pouvez me montrer d&apos;autres exemples de tunnels de vente ou sites Internet que vous avez réalisés ?
                            </summary>
                            <div className="mt-3 font-serif font-medium lg:text-xl text-xs  leading-6 text-black ">
