...
export default function PhoneIcon(){
    return(
        ...
        <Link href={'https://wa.me/0762911734'} target="_blank" className="bg-black border-2 border-[#EFFF0A] hover:bg-[#F2FD01] hover:border-black duration-500 w-fit p-2 rounded-full ">
