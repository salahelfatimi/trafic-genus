        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80 text-white p-4 z-50">
          <div className="container mx-auto max-w-md bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <div className="flex gap-4 justify-center">
              <button
                className="bg-primary text-gray-900 font-semibold py-2 px-4 rounded hover:bg-transparent border-2 border-primary hover:text-primary transition"
                onClick={() => handleCookiesDecision(true)}
              >
                Accepter
              </button>
              <button
                className="bg-gray-600 text-white font-semibold py-2 px-4 rounded hover:bg-gray-700 transition"
                onClick={() => handleCookiesDecision(false)}
              >
                Refuser
              </button>
            </div>
