  ...
  return (
    <>
      {images.map((ele, index) => (
        <div className=" cursor-pointer select-none	 relative duration-700 bg-black  space-x-6  p-4 flex flex-col items-center justify-start gap-20  border-2   border-[#fff]  min-w-80  " key={index}>
